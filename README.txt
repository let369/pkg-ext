...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/pkgext>.
...
as org.example/pkg-ext:0.1.0-SNAPSHOT
